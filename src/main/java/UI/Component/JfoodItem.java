...
//        this.addMouseListener(l);
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (contents != null)
            g2.drawString(contents,width /2-5, (int) (0.5 * height));
        Image img = new ImageIcon(imagePath).getImage();
        g2.drawImage(img,  (int) (0.02 * width), 5, (int)(getHeight()-10 ), (int)(getHeight()-15),null);// must set width andd height, otherwise it will not display it
    }
